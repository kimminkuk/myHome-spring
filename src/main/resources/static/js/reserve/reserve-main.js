...
function makeCalendarYear2023() {
    ...
    // Year를 선택할 때, 해당 Year의 Month를 보여준다.
...
function makeCalendarYear2021() {
    console.log("makeCalendarYear2021 Call");
    return;
}

function makeCalendarYear2024() {
    console.log("makeCalendarYear2024 Call");
    return;
}
